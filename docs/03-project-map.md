...
| `src/components/site-header.tsx` | The navigation bar (Scores, Leaderboard, account). Reads the session server-side; shows the visitor as signed out when the API cannot be reached. |
