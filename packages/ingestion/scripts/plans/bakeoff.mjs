...
export default {
  ...
  competitions: [
    ...
    {
      label: 'La Liga',
      ids: { api_football: '140', football_data_org: '2014', highlightly: '119924' },
      seasonLabel: '2023/24',
      from: '2023-08-11',
      to: '2023-08-13',
    },
    {
      label: 'Bundesliga',
      ids: { api_football: '78', football_data_org: '2002', highlightly: '67162' },
      seasonLabel: '2023/24',
      from: '2023-08-18',
      to: '2023-08-20',
    },
    {
      label: 'Serie A',
      ids: { api_football: '135', football_data_org: '2019', highlightly: '115669' },
      seasonLabel: '2023/24',
      from: '2023-08-19',
      to: '2023-08-21',
    },
    {
      label: 'Ligue 1',
      ids: { api_football: '61', football_data_org: '2015', highlightly: '52695' },
      seasonLabel: '2023/24',
      from: '2023-08-11',
      to: '2023-08-13',
    },
